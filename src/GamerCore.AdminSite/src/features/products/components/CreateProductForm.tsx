  ...
  return (
    <div className="container-fluid py-3">
      <div className="card shadow-sm">
        ...
        {createError && <div className="card-body py-2 px-3 border-bottom bg-light bg-opacity-25">
              ...
              <div className="col-md-6">
                ...
                <div className="card mt-3">
                  ...
                  <div className="card-body">
                    {/* Primary Image URL */}
                    <div className="mb-2">
                      <label htmlFor="primaryImageUrl" className="form-label small mb-1">Primary Image URL</label>
                      <input
                        id="primaryImageUrl"
                        className="form-control form-control-sm"
                    ...
                    <div className="border rounded p-2 bg-light bg-opacity-50" style={{ maxHeight: "200px", overflowY: "auto" }}>
